...
export const config = {
  ...
  filecoinWalletKey: optionalEnv('FILECOIN_WALLET_KEY'),
  filecoinNetwork: optionalEnv('FILECOIN_NETWORK'),
  alkahestContractAddress: optionalEnv('ALKAHEST_CONTRACT_ADDRESS'),
